...
function var_range(){
  # Celsius
  case $1 in
    tas) echo "zmin -8 zmax 29 dz 1" ;;
    tasmax) echo "zmin -2 zmax 39 dz 1" ;;
    tasmin) echo "zmin -13 zmax 23 dz 1" ;;
    pr) echo "zmin 0 zmax 9 dz 1" ;;
  esac
}
...
#    bash plot_escena_data.gmt.sh ${ncdir}/Spain02D_${var}_clim.2001.nc var $var cpt cpts/tas.cpt $(var_range $var)  national_bound out Spain02D_2001.${var}_clim.eps
#    irec=0
#    for seas in DJF MAM JJA SON; do
#      bash plot_escena_data.gmt.sh ${ncdir}/Spain02D_${var}_sclim.2001.nc \
...
#  done
#  for var in pr; do
#    bash plot_escena_data.gmt.sh ${ncdir}/Spain02D_${var}_clim.2001.nc var $var cpt cpts/pr.cpt $(var_range $var) national_bound out Spain02D_2001.${var}_clim.eps
#    irec=0
#    for seas in DJF MAM JJA SON; do
#      bash plot_escena_data.gmt.sh ${ncdir}/Spain02D_${var}_sclim.2001.nc \
#        out Spain02D_2001.${var}_sclim.eps \
