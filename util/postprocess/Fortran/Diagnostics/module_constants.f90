...
!   456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789
  ...
  REAL, PARAMETER                                          :: es_base_bolton=0.6112
  REAL, PARAMETER                                          :: es_Abolton=17.67
  REAL, PARAMETER                                          :: es_Bbolton=243.5
...
!      e0: reference saturation vapor pressure (at T=273.15 K) [hPa]
!      eps_gamma: epsilon constant from 'psychrometer constant' (gamma)
!      error: error value
! Tetens equation (Tetens, 1930) for saturated vapor pressure, es=es_base*10**((T*A)/(T+B)) [hPa]
!      es_base_tetens: base value [hPa]
...
!      es_base_bolton: constant for saturated vapor pressure [kPa] following bolton
!        es=es_base*exp[A*T/(T+B)] [kPa]
!      es_[A/B]bolton: constants for saturated vapor pressure [kPa]
