...
SUBROUTINE com_diagnostics(dbg, ifiles, Ninfiles, Diags, Ndiags, deltaX, deltaY, dimsIname,     &
  dimsOname, NdimsO, ofile, g_att_file, car_x, car_y)
...
!  INTEGER, ALLOCATABLE, DIMENSION(:)                     :: dims_in, dims_out
  INTEGER                                                :: Ndimsin
  INTEGER                                                :: ierr, oid, jvar, rcode
  INTEGER                                                :: lastjvar
  INTEGER                                                :: Ndimsdiag
!  INTEGER, DIMENSION(4)                                  :: start_dims, dims_out, dimido
...
! dims_in: vector with range of variables of input file
