...
echo "****************************"
echo "verify_WRF4GsimH.bash 'FOLDER' (simulation folder) \
...
do
  ...
  then
    nTOT=`ls -1 $1/$6${SIMi}_${SIMf}/output/wrfout*.nc | wc -l`
    TOT=`du -c $1/$6${SIMi}_${SIMf}/output/wrfout*.nc | grep total | awk '{print $1}'`
